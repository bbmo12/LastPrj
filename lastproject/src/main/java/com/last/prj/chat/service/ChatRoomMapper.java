...
public interface ChatRoomMapper {
	...
	public ChatRoomVO findByChatId(@Param("sender_id") String sender_id, @Param("receiver_id") String receiver_id);

	// 기존 채팅내역 가져옴.
	public List<ChatRoomVO> readChatHistory(ChatRoomVO chatroom) throws IOException;

	// 채팅 파일 생성
	/* public void createFile(@Param("c_no") int c_no) throws IOException; */
