					...
					<tbody id="myTable">
						<c:forEach items="${pmembers }" var="pmember">
							<tr>								
								...
								<td><meter value="${pmember.c_report}" min="0" max="100" low="20" high="65" optimum="15" style="width: 100%"></meter></td>
								<td>${pmember.startdate}</td>
								<td><a href="admPlistCode?f_content=${pmember.f_content}">${pmember.f_content}</a></td>
							</tr>
						</c:forEach>
