			...
			<div class="content-wrapper">
				<div class="card">
					<div class="card-body">
						...
						<form class="forms-sample" action="mjoin" method="post"
							...
							<div class="form-group">
								<label for="exampleInputEmail3">아이디*</label> <input type="email"
									class="form-control" id="m_id" name="m_id" placeholder="Email">
