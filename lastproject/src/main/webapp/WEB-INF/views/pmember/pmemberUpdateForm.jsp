...
<body>
			...
			<div class="row">
				...
				<div class="col-lg-9 posts-list">
					<div class="single-post row">
						<form action="pmemberUpdate" enctype="multipart/form-data"
							...
							<div class="col-lg-9 col-md-9 blog_details" id="main-form">
								...
								<div class="form-group">
									...
									<input type="tel" id="tel" name="tel" class="form-control"
										value="${pmember.tel}" placeholder="숫자만 입력하세요." maxlength="13">
								</div>
								<div class="form-group">
								...
								<div id="select-one">
									<div class="form-group" id="form-time">
										<c:forEach items="${time }" var="timeList" varStatus="status">
											<div>
												<input type="hidden" name="timeVOList[${status.index}].o_no"value="${timeList.o_no}"> 
									...
									<div id="add-div">
										<c:forEach items="${price }" var="price" varStatus="status">
											<div class="form-group" id="service-main" style="margin-bottom: 10px;">
												<input type="hidden"name="priceVOList[${status.index }].price_no"value="${price.price_no}">
												...
												<input type="hidden"name="priceVOList[${status.index }].p_id" value="${pId}">
											</div>
										</c:forEach>
									</div>
								</div>
	...
	<script>	
		...
		/* $(document).on('change','.selectday',function(){
		  	...
		  	var day = document.getElementById('timeVOList.w_day');
		  	day = $("select[name=w_day]").val();
		  	var start =  document.getElementById('timeVOList.starttime');
		  	start = $("select[name=starttime]").val();
		  	var end =  document.getElementById('timeVOList.endtime');
		  	end = $("select[name=endtime]").val();
		  	var content =  document.getElementById('timeVOList.n_content');
		  	content = $("input[name=n_content]").val();
		...
		<div class="form-group" style="margin-bottom: 10px;">
			<input type="hidden" name="price_no">
			<div class="service-info">
				<label for="name">서비스명</label>
			...
			<div style="display: inline-grid;">
				<label>서비스안내</label>
				<textarea class="form-control" id="content" name="content" rows="2" cols="50"
		...
		function plusTime() {
			...
			form.innerHTML += `		
					<div>
					<select class="selectday" name="timeVOList[].w_day">
				...
				<select class="selectday" name="timeVOList[].starttime">
				...
				<select class="selectday" name="timeVOList[].endtime">
				...
				<input type="text" id="n_content" name="timeVOList[].n_content" class="form-control" value=""><br>
