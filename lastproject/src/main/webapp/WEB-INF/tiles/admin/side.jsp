...
<nav class="sidebar sidebar-offcanvas" id="sidebar">
	<ul class="nav">
		...
		<li class="nav-item"><a class="nav-link"
			href="pages/icons/mdi.html"> <span class="icon-bg"><i
					class="mdi mdi-contacts menu-icon"></i></span> <span class="menu-title">Icons</span>
		</a></li>
		<li class="nav-item"><a class="nav-link"
			href="pages/forms/basic_elements.html"> <span class="icon-bg"><i
		...
		<li class="nav-item sidebar-user-actions">
			<div class="sidebar-user-menu">
				<a href="adminLogout.do" class="nav-link"><i class="mdi mdi-logout menu-icon"></i>
