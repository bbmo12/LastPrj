...
<body>
		...
		<nav
			...
			<div
				...
				<a class="navbar-brand brand-logo" href="index.html"><img
					src="resources/assets/images/logo.svg" alt="logo" /></a> <a
					class="navbar-brand brand-logo-mini" href="index.html"><img
					src="resources/assets/images/logo-mini.svg" alt="logo" /></a>
			</div>
						...
						<div
							...
							<div class="p-3 text-center bg-primary">
								<img class="img-avatar img-avatar48 img-avatar-thumb"
									src="resources/assets/images/faces/face28.png" alt="">
							</div>
							<div class="p-2">
	...
	<script
		src="resources/assets/vendors/jquery-circle-progress/js/circle-progress.min.js"></script>
